...
**보류 항목** (사용자 요청, 2026-08-18): ① decimation magnitude=1 확정 후 3-2/3-3/3-4가 magnitude=2 조건에서 나온 값이라 미재검증 ② 캘리퍼 실측값 없어 절대 정확도 미검증(3, 세그멘테이션 단계에서 재시도 예정) ③ 6번 N=50 자기참조 편향. 급한 이슈는 아니라 4번(Segmentation)으로 우선 진행.
